// $ANTLR : "analexEntrada.g" -> "AnalexEntrada.java"$
...
public class AnalexEntrada extends antlr.CharScanner implements AnalexEntradaTokenTypes, TokenStream
 {
public AnalexEntrada(InputStream in) {
	this(new ByteBuffer(in));
}
public AnalexEntrada(Reader in) {
	this(new CharBuffer(in));
}
public AnalexEntrada(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public AnalexEntrada(LexerSharedInputState state) {
	super(state);
...
tryAgain:
	...
	public final void mLETRA(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = LETRA;
		int _saveIndex;
